...
namespace PestKontroll.Controllers
{
    public class TicketCommentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Comment,Created,TicktId,UserId")] TicketComment ticketComment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Comment,Created,TicktId,UserId")] TicketComment ticketComment)
        {
