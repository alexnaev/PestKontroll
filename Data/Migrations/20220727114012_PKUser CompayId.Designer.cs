...
namespace PestKontroll.Data.Migrations
{
    ...
    [Migration("20220727114012_PKUser CompayId")]
    partial class PKUserCompayId
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PestKontroll.Models.PKUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PKUserProject", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PestKontroll.Models.PKUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PestKontroll.Models.Invite", b =>
                {
                    ...
                    b.HasOne("PestKontroll.Models.PKUser", "Invitee")
                        .WithMany()
                        .HasForeignKey("InviteeId");

                    b.HasOne("PestKontroll.Models.PKUser", "Invitor")
                        .WithMany()
            ...
            modelBuilder.Entity("PestKontroll.Models.Notification", b =>
                {
                    b.HasOne("PestKontroll.Models.PKUser", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PestKontroll.Models.PKUser", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("PestKontroll.Models.Ticket", b =>
                {
                    b.HasOne("PestKontroll.Models.PKUser", "DeveloperUser")
                        .WithMany()
                        .HasForeignKey("DeveloperUserId");

                    b.HasOne("PestKontroll.Models.PKUser", "OwnerUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PestKontroll.Models.TicketAttachment", b =>
                {
                    ...
                    b.HasOne("PestKontroll.Models.PKUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
